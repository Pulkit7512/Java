...
class FileReadWrite {
    ...
    public void characterCount(){
        try {
            FileReader fileread = new FileReader("C:\\Users\\Pulkit Prakash\\IdeaProjects\\fileQuestion.txt");
            int index;
    ...
    public void saveData() {
        try {
            File f1 = new File("C:\\Users\\Pulkit Prakash\\IdeaProjects\\fileAnswer.txt");
